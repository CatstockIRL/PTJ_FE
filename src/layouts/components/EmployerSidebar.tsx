...
const EmployerSidebar: React.FC<SidebarProps> = ({ isOpen }) => {
  ...
  const adminItems: MenuItem[] = [
    ...
    getItem(<NavLink to="/admin/categories">Quản lý danh mục</NavLink>, "/admin/categories", <AppstoreOutlined />),
  ...
  return (
    <aside
      className={`bg-white shadow-lg border-r-4 border-blue-500 flex flex-col flex-shrink-0 sticky top-[68px] h-[calc(100vh-68px)] transition-all duration-300 ${
        isOpen ? "w-64" : "w-20"
      }`}
    >
