...
const JobCard: React.FC<JobCardProps> = ({ job }) => {
  return (
    ...
    <div className="bg-white p-4 rounded-lg shadow-md flex items-start space-x-4 relative w-full border border-gray-200 h-40">
      ...
      <div className="flex-1 overflow-hidden">
        <div className="flex items-start mb-1">
          ...
          <button className="absolute top-4 right-4 text-gray-400 hover:text-red-500"><i className="far fa-heart"></i></button>
        </div>
