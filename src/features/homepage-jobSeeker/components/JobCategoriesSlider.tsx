          ...
          <Slider ref={sliderRef} {...settings} autoplay>
            {jobCategories.map((category) => (
              <div key={category.id} className="p-2">
                <div className="p-4 rounded-lg shadow-md bg-white flex flex-col items-center justify-center h-full">
                  <img src={category.icon} alt={`${category.name} icon`} className="mx-auto mb-2 w-16 h-16" />
                  <h3 className="text-md font-semibold text-gray-800 text-center">{category.name}</h3>
