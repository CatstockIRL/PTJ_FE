...
const JobEmployerDetailView: React.FC<{ post: AdminEmployerPostDetailView }> = ({
  post,
}) => {
  return (
    <div className="p-2">
      ...
      <DetailField label="Mô tả" isHtml>
        {post.description}
      </DetailField>
      <DetailField label="Yêu cầu" isHtml>
        {post.requirements}
      </DetailField>
    </div>
  );
