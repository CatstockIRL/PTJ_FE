        ...
        <div className="pt-16 text-center px-4 flex-1 flex flex-col justify-between">
          ...
          <div className="mt-auto">
            <p className="text-gray-600 text-sm mt-2">
              {employer.jobCount > 0 ? (
                  <span className="text-blue-600 font-semibold">{employer.jobCount} việc đang tuyển</span>
              ) : (
                  <span>Hiện chưa có tuyển dụng</span>
              )}
            </p>

            <div className="flex items-center justify-center text-gray-500 text-xs mt-1" title={locationDisplay}>
