...
const HotNewsItem: React.FC<{ item: any; onClick: (id: number) => void }> = ({
  item,
  onClick,
}) => (
  <div
    ...
    <div className="flex gap-3">
      <div className="relative w-24 h-24 flex-shrink-0 rounded-md overflow-hidden">
        ...
        <div className="absolute top-0 left-0">
          <Tag
            color="#f50"
            className="m-0 rounded-br-md border-none text-[10px] font-bold px-1"
          >
            ...
            <div className="bg-white p-5 rounded-xl shadow-sm sticky top-6 border border-gray-100">
              ...
              <Spin spinning={loadingList}>
                {hotNews.length > 0 ? (
                  ...
                  <Empty
                    description="Không có tin nổi bật"
            ...
            <Card className="shadow-sm rounded-xl overflow-hidden border-none">
              ...
              <div className="mb-6">
                {newsDetail.category && (
                  <Tag
                    color="geekblue"
                    className="mb-3 text-sm py-1 px-3 rounded-full font-semibold"
                  >
                ...
                <div className="flex flex-wrap items-center gap-6 text-gray-500 text-sm border-b border-gray-100 pb-6">
                  ...
                  <div className="flex items-center">
                    ...
                    <span>
                      {dayjs(newsDetail.createdAt).format("DD/MM/YYYY HH:mm")}
                    </span>
                  </div>
                </div>
              </div>
